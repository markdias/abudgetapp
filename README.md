...
5. Enable **Process Transactions Automatically** from Settings → Automation to have scheduled payments post against pots on their due dates after transfers have been executed for the month. You can also use **Process Transactions Now** on the Transfers tab to force a run if you need to reconcile immediately.
