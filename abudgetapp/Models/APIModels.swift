...
public struct TransactionEntry: Identifiable, Codable, Hashable {
    public let id: Int
    public let amount: Double
    public let description: String
    public let date: String
    ...
    public init(id: Int, amount: Double, description: String, date: String, merchant: String? = nil, isCredit: Bool) {
        self.id = id
        self.amount = amount
        self.description = description
        self.date = date
...
public struct TransactionSubmission: Codable {
    ...
    public init(amount: Double, description: String, date: String, merchant: String? = nil, isCredit: Bool) {
        self.amount = amount
        self.description = description
        self.date = date
        self.merchant = merchant
