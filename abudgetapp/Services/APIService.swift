...
protocol APIServiceProtocol {
    ...
    func addTransaction(accountId: Int, transaction: TransactionSubmission) async throws -> TransactionEntry
    func updateTransaction(accountId: Int, transactionId: Int, transaction: TransactionSubmission) async throws -> TransactionEntry
    ...
    func deleteTransaction(accountId: Int, transactionId: Int) async throws -> MessageResponse
...
final class APIService: APIServiceProtocol {
    ...
    func addTransaction(accountId: Int, transaction: TransactionSubmission) async throws -> TransactionEntry {
        do {
            return try await store.addTransaction(accountId: accountId, submission: transaction)
        } catch {
            throw map(error)
        }
    }
    ...
    func updateTransaction(accountId: Int, transactionId: Int, transaction: TransactionSubmission) async throws -> TransactionEntry {
        do {
            return try await store.updateTransaction(accountId: accountId, transactionId: transactionId, submission: transaction)
        } catch {
            throw map(error)
        }
    }
    ...
    func deleteTransaction(accountId: Int, transactionId: Int) async throws -> MessageResponse {
        do {
            try await store.deleteTransaction(accountId: accountId, transactionId: transactionId)
